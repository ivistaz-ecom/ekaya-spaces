    ...
    <>
      {
        error ? (
          ...
          <div className="h-[40vh] bg-[#5CA2B0] relative mx-auto" data-aos='fade-down'>
            <div className='w-full absolute bottom-0 lg:py-12 text-center pb-28 mx-auto' data-aos="fade-down">
              <h1 className='lg:text-[10em] md:text-5xl text-3xl text-white poppins-medium'> 404</h1>
          ...
          <div className="lg:h-screen relative mx-auto" data-aos='fade-down'>
            ...
            />
            <div className='lg:w-[50%] w-full absolute bottom-0 lg:py-12 lg:ml-40 md:ml-20 ml-5 pb-28' >
              {/* dangerouslySetInnerHTML={{ __html:pageTitle  }} */}
              {/* {pageTitle} */}

              <h1 className='lg:text-6xl md:text-5xl text-3xl text-white poppins-light' dangerouslySetInnerHTML={{ __html: pageTitle }} />
