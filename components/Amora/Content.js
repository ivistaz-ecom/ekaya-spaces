...
function Content() {
  ...
  return (
    <div>
          ...
          <h1 className='text-2xl text-e-green font-light tracking-[0.2em] pb-12'>ABOUT THE PROJECT</h1>
         <h4 className='text-4xl text-black poppins-light pb-6'>Amora Villas</h4>
          <p className='poppins-light text-[18px] text-start pb-5'>Located in the serene coastal town of Moira, nestled amidst the verdant landscapes and tranquil ambience, lies the prestigious Amora Villas project developed by Ekaya Spaces LLP. Spanning across a sprawling expanse of 1250 square meters of prime land, Amora Villas epitomises luxury vacation living at its finest. With meticulous attention to detail and an unwavering commitment to excellence, this project redefines opulence in the heart of Goa.</p>
              
              <p className='poppins-light  text-[18px] text-start pb-5'>The name “Amora” itself is derived from the Portuguese and Spanish word for love, reflecting the essence of affection and warmth that permeates every aspect of this luxurious retreat.</p>
              <p className='poppins-light  text-[18px] text-start'>Comprising four exquisite villas, each meticulously designed to offer the epitome of comfort and sophistication, Amora Villas presents a haven of tranquility and elegance for vacationers. Each villa boasts four spacious bedrooms, meticulously crafted to ensure utmost comfort and privacy, making them perfect retreats for families and friends seeking a luxurious getaway. What sets these bedrooms apart is the inclusion of individual gardens or terraces, allowing guests to bask in the natural beauty of their surroundings right from the comfort of their private quarters.</p>
          </div>
          ...
          <div className='w-[80%] mx-auto' data-aos="fade-down">
              ...
              <p className='poppins-light  text-[18px] text-start'>For those seeking moments of conviviality and entertainment, the rooftop bar offers a chic setting to unwind with friends and family while enjoying panoramic views of the surrounding landscape. Whether savouring sundowners or hosting intimate gatherings, the rooftop bar serves as the perfect venue for creating cherished vacation memories.</p>
            </div>
...
<div className="h-[600px] relative mx-auto py-12" data-aos='fade-down'>
 <Image
        src="/amora-bt.png"
        alt="Banner"
      ...
      />
          ...
          <div className='w-[80%] mx-auto pt-6' data-aos="fade-down">
                ...
                <div className='grid grid-flow-row-dense grid-cols-3 py-4 '>
                    ...
                    <div className='col-span-2'>
                        <ul className='poppins-light list-image-[url(/right-icon.svg)]'>
                          ...
                          <li className='text-[18px]'>Goa Medical College Hospital: 20 Km</li>
                ...
                <div className='grid grid-flow-row-dense grid-cols-3 py-4 '>
                    ...
                    <div className=''>
                        <ul className='poppins-light list-image-[url(/right-icon.svg)]'>
                            <li className='text-[18px]'>Sharada Mandir School, Miramar: 21 Km</li>
                            <li className='text-[18px]'>The Ardee School, Porvorim : 9.8 Km</li>
                        </ul>
                    </div>
                </div>
