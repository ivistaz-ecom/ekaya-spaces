  ...
  return (
    <div className="h-screen relative z-19" data-aos='fade-down'>
      ...
      />
          ...
          <div class="block">
            <h5 class="mb-2 text-2xl font-light tracking-tight text-white">Dona Paula</h5>
          </div>
          ...
          <div class="block">
            <h5 class="mb-2 text-2xl font-light tracking-tight text-white poppins-light">Goa</h5>
                  </div>
                  <div class="inline-block h-[28px] min-h-[0.20em] w-[0.15em] self-stretch bg-white lg:block hidden"></div>
