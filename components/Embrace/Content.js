    ...
    <div>
         ...
         <h4 className='text-4xl text-black poppins-light pb-6'>Modern idyll in a three-storey block with<br/> six luxurious homes</h4>
          ...
          <div className='grid grid-cols-2 py-12'>
              <div className='bg-e-green content-center p-[9em]'>
         ...
         <h4 className='text-4xl text-black poppins-light pb-6'>Spacious, modern homes with thoughtful layouts</h4>
          <p className='poppins-light text-[18px] text-start pb-5'>Within view of Bengaluru’s newest and hottest landmark destination - Embassy One (Four Seasons Hotel and Residences), Ekaya’s Embrace is just off Bellary Main Road, cocooned in the most sought after, premium residential neighbourhood of Ganga Nagar.</p>
              <p className='poppins-light  text-[18px] text-start'>At Embrace compromise is never an option. Only the best of everything has been utilized, Right from the building material, to its 24-power back up, to the maneuver-friendly stilt parking at ground level, to the finish with marble and wooden flooring.</p>
          ...
          <div className='bg-[#D5F0F0] py-12'>
              <div className='w-[80%] mx-auto'>
                  ...
                  <hr className='h-px border-t border-gray-300 mx-auto ' />
                  <div className='grid grid-cols-2 py-4'>
                  <div className='text-2xl'>Common Staircase</div>
                      <div> <ul className='poppins-light text-[18px] list-image-[url(/right-icon.svg)]'>
                  ...
                  <hr className='h-px border-t border-gray-300 mx-auto ' />
                  <div className='grid grid-cols-2 py-4'>
                  <div className='text-2xl'>Common Areas</div>
                      <div>
          ...
          <div className='bg-[#CAB575] py-12 text-white'>
              <div className='w-[80%] mx-auto'>
                  ...
                  <hr className='h-px border-t border-gray-300 mx-auto ' />
                  <div className='grid grid-cols-2 py-4'>
                  <div className='text-2xl'>D.G</div>
                      <div> <ul className='poppins-light text-[18px] list-image-[url(/right-icon.svg)]'>
...
<div class="mb-4 border-b border-gray-200 dark:border-gray-700">
    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-styled-tab" data-tabs-toggle="#default-styled-tab-content" data-tabs-active-classes="text-e-green hover:text-e-green dark:text-purple-500 dark:hover:text-purple-500 border-e-green dark:border-purple-500" data-tabs-inactive-classes="dark:border-transparent text-gray-500 hover:text-gray-600 dark:text-gray-400 border-gray-100 hover:border-gray-300 dark:border-gray-700 dark:hover:text-gray-300" role="tablist">
        ...
        <li class="me-2" role="presentation">
            <button class="inline-block p-4 border-b-2 rounded-t-lg text-xl poppins-light hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="dashboard-styled-tab" data-tabs-target="#styled-dashboard" type="button" role="tab" aria-controls="dashboard" aria-selected="false">3D rendered</button>
        </li>
        <li class="me-2" role="presentation">
            <button class="inline-block p-4 border-b-2 rounded-t-lg text-xl poppins-light hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="settings-styled-tab" data-tabs-target="#styled-settings" type="button" role="tab" aria-controls="settings" aria-selected="false">Floor plan parking</button>
        </li>
        <li role="presentation">
            <button class="inline-block p-4 border-b-2 rounded-t-lg text-xl poppins-light hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="contacts-styled-tab" data-tabs-target="#styled-contacts" type="button" role="tab" aria-controls="contacts" aria-selected="false">Floor plan — 3 floors</button>
                      </li>
                      <li role="presentation">
            <button class="inline-block p-4 border-b-2 rounded-t-lg text-xl poppins-light hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="contacts-styled-tab" data-tabs-target="#styled-contacts" type="button" role="tab" aria-controls="contacts" aria-selected="false">Unit floor plan design layout</button>
                      ...
                      <li role="presentation">
            <button class="inline-block p-4 border-b-2 rounded-t-lg text-xl poppins-light hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="contacts-styled-tab" data-tabs-target="#styled-contacts" type="button" role="tab" aria-controls="contacts" aria-selected="false">Features</button>
        </li>
    </ul>
</div>
