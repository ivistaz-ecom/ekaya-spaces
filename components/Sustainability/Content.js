...
<div class="flex flex-col items-center bg-white md:flex-row w-[90%]">
    <img class="object-cover w-[25em] mr-10"  src="/sus.png" alt=""/>
        ...
        <p class="mb-3 poppins-light text-[18px] text-start pb-5">Water conservation is a priority for us. That’s why we’ve implemented rainwater harvesting systems across our facilities. By capturing rainwater runoff, we reduce reliance on traditional water sources and support local ecosystems.</p>
                ...
                <div class="flex flex-col items-center bg-white md:flex-row w-[90%] justify-items-end">
                    <div class="flex flex-col justify-between leading-normal">
        ...
        <p class="mb-3 poppins-light text-[18px] text-start pb-5 ml-36">We prioritize minimizing damage to local ecology in all our endeavors. Whether constructing new facilities or expanding existing ones, we conduct thorough environmental impact assessments to identify and mitigate potential risks to nearby ecosystems.</p>
                    ...
                    <img class="object-cover w-[25em] ml-10"  src="/sus-1.png" alt=""/>
                </div>



<div class="flex flex-col items-center bg-white md:flex-row w-[90%]">
    <img class="object-cover w-[25em] mr-10"  src="/sus-2.png" alt=""/>
                    <div class="flex flex-col justify-between leading-normal">
...
<div class="flex flex-col items-center bg-white md:flex-row w-[90%] z-50">
                <div class="flex flex-col justify-between leading-normal">
                ...
                <p class="mb-3 poppins-light text-[18px] text-start pb-5 ml-10 ml-36">To reduce our reliance on fossil fuels, we utilize solar power through installations like rooftop panels and solar farms. By embracing solar energy, we lower our carbon emissions and contribute to a cleaner, more sustainable future.</p>
                    ...
                    <img class="object-cover w-[25em] ml-10"  src="/sus-3.png" alt=""/>
                </div>   

                <div className="z-0 -mt-20 bg-no-repeat bg-white bg-cover bg-[url('/sus-banner.png')] bg-gray-300 bg-blend-multiply h-screen relative">
