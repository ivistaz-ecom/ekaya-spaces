...
function Crafted() {
  return (
    <div className='text-center mt-[100px] lg:w-[70%] w-full mx-auto p-4'>
          <h2 className='text-2xl text-e-green font-light tracking-[0.2em]'>ABOUT EKAYA</h2>
          <h2 className='lg:text-5xl text-4xl poppins-regular py-10'>Homes crafted<br/> with passion</h2>
