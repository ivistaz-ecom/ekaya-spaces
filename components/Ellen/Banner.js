  ...
  return (
    <div className="lg:h-[100vh] relative mx-auto" data-aos='fade-down'>
      ...
      />
          ...
          <div class="block">
            <h5 class="mb-2 lg:text-2xl text-[18px] font-light tracking-tight text-white">Off Langford Main Road</h5>
          </div>
          ...
          <div class="block">
            <h5 class="mb-2 lg:text-2xl text-[18px] font-light tracking-tight text-white poppins-light">Bengaluru</h5>
                  </div>
                  <div class="inline-block h-[28px] min-h-[0.20em] w-[0.15em] self-stretch bg-white lg:block md:block hidden"></div>
          <hr className='h-px border-t w-9/12 border-white pb-4 mx-auto lg:hidden hidden'/>
          <div class="block">
