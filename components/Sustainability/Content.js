...
function Content() {
    ...
    <div className='mt-[100px] w-[80%] mx-auto' data-aos='fade-down'>
          <h1 className='text-5xl text-e-green font-light poppins-light pb-6'>Embracing Sustainability:</h1>
          <h2 className='text-5xl text-black font-light pb-12 leading-[1.3em] poppins-light'>Our Company’s Environmental<br/> Commitment</h2>
...
<div class="flex flex-col items-center bg-white md:flex-row w-[90%]" data-aos='fade-right'>
    <Image class="object-cover w-[25em] mr-10"  src="/sus.png" alt=""  width={800} height={500}/>
        ...
        <p class="mb-3 poppins-light text-[18px] text-start pb-5">Water conservation is a priority for us. That’s why we’ve implemented rainwater harvesting systems across our facilities. By capturing rainwater runoff, we reduce reliance on traditional water sources and support local ecosystems.</p>
                ...
                <div class="flex flex-col items-center bg-white md:flex-row w-[90%] justify-items-end" data-aos='fade-left'>
                    <div class="flex flex-col justify-between leading-normal">
                    <h5 class="mb-2 text-2xl poppins-medium tracking-tight text-gray-900 dark:text-white ml-36">Preserving Ecological Balance: Minimizing Impact, Maximizing Harmony</h5>
        <p class="mb-3 poppins-light text-[18px] text-start pb-5 ml-36">We prioritize minimizing damage to local ecology in all our endeavors. Whether constructing new facilities or expanding existing ones, we conduct thorough environmental impact assessments to identify and mitigate potential risks to nearby ecosystems.</p>
                    </div>
                    <Image class="object-cover w-[25em] ml-10"  src="/sus-1.png" alt=""  width={800} height={500}/>
                </div>



<div class="flex flex-col items-center bg-white md:flex-row w-[90%]" data-aos='fade-right'>
    <Image class="object-cover w-[25em] mr-10"  src="/sus-2.png" alt=""  width={800} height={500}/>
                    <div class="flex flex-col justify-between leading-normal">
...
<div class="flex flex-col items-center bg-white md:flex-row w-[90%] z-50" data-aos='fade-left'>
                <div class="flex flex-col justify-between leading-normal">
                <h5 class="mb-2 text-2xl poppins-medium tracking-tight text-gray-900 dark:text-white ml-36">Harnessing Solar Power: Sustainable Energy Solutions</h5>
                <p class="mb-3 poppins-light text-[18px] text-start pb-5 ml-10 ml-36">To reduce our reliance on fossil fuels, we utilize solar power through installations like rooftop panels and solar farms. By embracing solar energy, we lower our carbon emissions and contribute to a cleaner, more sustainable future.</p>
                    </div>
                    <Image src="/sus-3.png" alt="" className="w-full object-cover w-[25em] ml-10" width={60} height={60}/>
                </div>   

            <div className="z-0 -mt-20  bg-whitebg-blend-multiply h-screen relative" data-aos='fade-up'>                
            <Image
        src="/sus-banner.png"
        alt="Banner"
