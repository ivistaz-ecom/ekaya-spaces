...
function Clients() {
  return (
    ...
    <div className='text-center mt-[100px] w-[80%] mx-auto'>
        ...
        <p className='poppins-light text-2xl py-14'>“Discovering Ekaya was like finding a hidden gem. The attention to detail and personal touch they bring to every aspect of the home-buying experience is truly unparalleled.”</p>
