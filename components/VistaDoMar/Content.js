    ...
    return (
        <div>
            <div className='mt-[100px] w-[80%] mx-auto' data-aos="fade-up">
                ...
                <p className='poppins-light text-[18px] text-start pb-5'>When the time came for Siandra’s wedding, her parents asked her what she desired as a gift. Without hesitation, Siandra expressed her wish for a plot of land in Goa.</p>
                <p className='poppins-light text-[18px] text-start pb-5'>Throughout the years, whenever Alvit and Esmeralda visited Goa, they would drive from Loutolim, Esmeralda’s grandmother’s home, to Dona Paula. Standing on a particular spot overlooking the majestic Marmagoa harbor, Alvit would declare, “One day, I will build a house here!”</p>
                <p className='poppins-light text-[18px] text-start pb-5'>Fate intervened, and Alvit finally found three plots in Dona Paula. One was gifted to Siandra, another was designated as an orchard, and the third became the site of their dream home, named Vista do Mar, meaning “views of the sea” in Portuguese.</p>
                ...
                <div className='lg:w-[80%] sm:w-[80%] w-[80%] mx-auto'>
                    ...
                    <div className='grid lg:grid-cols-2 sm:grid-cols-2 grid-cols-1 py-4'>
                        ...
                        <div>
                            ...
                            <ul className="poppins-light text-[18px] list-image-[url(/right-icon.svg)] pb-1">
                                <li>Vitrified tiles : Creanza tiles.1600mm x 1600mm in the land owners share and 800mm x 1600mm in the other apartments.</li>
                    ...
                    <div className='grid lg:grid-cols-2 sm:grid-cols-2 grid-cols-1 py-4'>
                        ...
                        <div> <ul className='poppins-light text-[18px] list-image-[url(/right-icon.svg)]'>
                            ...
                            <li>False ceiling with grid panels or calcium silicate board.</li>
                        </ul></div>
                    </div>
                    <hr className='h-px border-t border-gray-300 mx-auto ' />
                    <div className='grid lg:grid-cols-2 sm:grid-cols-2 grid-cols-1 py-4'>
                    ...
                    <div className='grid lg:grid-cols-2 sm:grid-cols-2 grid-cols-1 py-4'>
                        ...
                        <div>
                            ...
                            <ul className='poppins-light list-image-[url(/right-icon.svg)]'>
                                <li className='text-[18px]'>Teak wood frame and Teak wood shutter with melamine polish and Yale digital locks.</li>
                            </ul>
                ...
                <div className='w-[80%] mx-auto'>
                    ...
                    <div className='grid lg:grid-cols-2 sm:grid-cols-2 grid-cols-1 py-4'>
                        ...
                        <div>
                            ...
                            <ul className='poppins-light list-image-[url(/right-icon.svg)]'>
                                <li className='text-[18px]'>Lifts - Make Schindler or equivalent. 12 Passenger.</li>
                            </ul>
                    ...
                    <div className='grid lg:grid-cols-2 sm:grid-cols-2 grid-cols-1 py-4'>
                        ...
                        <div>
                            <ul className='poppins-light list-image-[url(/right-icon.svg)]'>
                                <li className='text-[18px]'>Round with clock security with CCTV & intercom facility</li>
                            </ul>
                        </div>
                ...
                <div className='grid grid-flow-row-dense lg:grid-cols-3 grid-cols-1 py-4 '>
                    ...
                    <div className='col-span-2'>
                        <ul className='poppins-light list-image-[url(/right-icon.svg)]'>
                            ...
                            <li className='text-[18px]'>Goa Medival College Hospital : 5.6 Km</li>
                        </ul>
                    </div>
                </div>
